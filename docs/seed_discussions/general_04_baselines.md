...
2. We'll add it to the running comparison matrix in the next release
...
- Paper §3.2 comparison table (reproducible from the Zenodo archive).
- An external-validation dashboard is on the near-term roadmap.
