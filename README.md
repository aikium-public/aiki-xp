...
- 📄 **Paper:** Tien, Sharma Meda, Shastry & Mysore. *Nature Communications* (2026, submitted). Preprint: [bioRxiv 10.64898/2026.04.21.719525](https://doi.org/10.64898/2026.04.21.719525).
...
**Rate limits:** 10 requests/hour per IP, 100 user-added genomes
total, 15 Mb genome-size cap. Multi-record WGS-merged pickles
