#!/usr/bin/env python3
"""
S7 stepwise trajectory — single panel, non-conserved ρ.
Naming: "non-mega" displays as "non-conserved", "classical" as "biophysical".
"""
import json
import numpy as np
import matplotlib
...
# Champion reference — pooled 2-seed 5-fold CV.
champ_nc = 0.592
