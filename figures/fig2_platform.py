...
def generate_fig2():
    ...
    # Target gene = gene 2 at x ∈ [0.38, 0.60]. Anchor positions:
    #   - 5' UTR: x=0.37 → intergenic region immediately upstream of target
    #     (kept clear of gene 1, the left neighbour).
    #   - Protein: x=0.54 → inside the target gene (clear of gene 3).
    #   - Promoter: x=0.08 → inside the extended operon bracket.
    signals = [
